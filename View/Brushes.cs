...
public static class Brushes
{
    ...
    public static SKPaint Path { get; } = new SKPaint { Color = SKColors.Gray.WithAlpha(70), IsStroke = true, PathEffect = SKPathEffect.CreateDash([ 5, 5 ], 0) };
    public static SKPaint RebuiltPath { get; } = new SKPaint { Color = SKColors.Red, IsStroke = true };
